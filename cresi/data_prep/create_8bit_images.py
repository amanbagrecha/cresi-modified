...
###############################################################################
def dir_to_8bit_single_threaded(
    path_images_raw,
    path_images_8bit,
    command_file_loc="",
    outputPixType="Byte",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="5,3,2",
        help="',' separated list " " set to '' to use default band order, 1-indexed",
    )
    parser.add_argument(
        "--percentiles",
        type=str,
    ...
    parser.add_argument(
        "--n_threads", type=int, default=12, help="num threads for multiprocessing"
    )
